...
public class MainActivity extends BaseActivity {
	...
	public int getUnreadAddressCountTotal() {
		...
		if (ChatApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
			unreadAddressCountTotal = ChatApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME).getUnreadMsgCount();
...
//			message.getStringAttribute("");
	...
	private class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {
			// 保存增加的联系人
			Map<String, User> localUsers = ChatApplication.getInstance().getContactList();
