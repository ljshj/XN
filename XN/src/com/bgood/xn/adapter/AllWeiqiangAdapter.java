 ...
 * 微墙适配类
 */
public class AllWeiqiangAdapter extends KBaseAdapter
{

	public AllWeiqiangAdapter(List<?> mList, Activity mActivity) {
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		holder.deleteImgV.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                messageManager.registerObserver(AllWeiqiangAdapter.this);
