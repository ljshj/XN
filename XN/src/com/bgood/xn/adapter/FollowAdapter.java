 ...
 * 我的关注适配器
 */
public class FollowAdapter extends BaseAdapter implements UserCenterMessageManagerInterface
{
    ...
    public FollowAdapter(Context context, List<UserDTO> list)
    {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = m_inflater.inflate(R.layout.layout_follow_item, null);
