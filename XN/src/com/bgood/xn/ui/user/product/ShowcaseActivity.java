...
import com.zhuozhong.bandgood.activity.main.SearchResultActivity;
import com.zhuozhong.bandgood.adapter.ShowcaseAllProductAdapter;
import com.zhuozhong.bandgood.adapter.ShowcaseRecommendAdapter;
import com.zhuozhong.bandgood.bean.ProductDTO;
import com.zhuozhong.bandgood.bean.Reulst;
import com.zhuozhong.bandgood.bean.ShowcaseDTO;
import com.zhuozhong.bandgood.messagemanager.ShowCaseMessageManager;
import com.zhuozhong.bandgood.messagemanager.ShowCaseMessageManagerInterface;
import com.zhuozhong.manager.UserManager;
import com.zhuozhong.view.CBaseSlidingMenu;
import com.zhuozhong.view.slidingmenu.lib.SlidingMenu.OnClosedListener;
import com.zhuozhong.view.slidingmenu.lib.SlidingMenu.OnOpenedListener;
 ...
 * 我的橱窗页面
 */
public class ShowcaseActivity extends CBaseSlidingMenu implements OnClickListener, OnItemClickListener, ShowCaseMessageManagerInterface
{
...
//			m_allProductLayout.setVisibility(View.VISIBLE);
	...
	private void setRevommendAdapter(ArrayList<ProductDTO> list)
	{
		...
		{
			m_recommendAdapter = new ShowcaseRecommendAdapter(ShowcaseActivity.this, list);
	...
	private void setAllProductAdapter(ArrayList<ProductDTO> list)
	{
		...
		{
			m_allProductAdapter = new ShowcaseAllProductAdapter(ShowcaseActivity.this, list);
