 ...
 * 字母表
 */
public class ZZPrivinceQuickAlphabeticBar extends ImageButton
{
	...
	public ZZPrivinceQuickAlphabeticBar(Context context) {
		super(context);
	}

	public ZZPrivinceQuickAlphabeticBar(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public ZZPrivinceQuickAlphabeticBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	// 初始化
	public void init(Activity ctx) {
		mDialogText = (TextView) ctx.findViewById(R.id.privince_tv_fast_position);
